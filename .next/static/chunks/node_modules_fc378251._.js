...
"[project]/node_modules/moment-hijri/moment-hijri.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
************************************/ (function(root, factory) {
    /* global define */ if (typeof define === 'function' && define.amd) {
        ((r)=>r !== undefined && __turbopack_context__.v(r))(function(moment) {
            root.moment = factory(moment);
            return root.moment;
        }(__turbopack_context__.r("[project]/node_modules/moment/moment.js [app-client] (ecmascript)")));
    } else if ("TURBOPACK compile-time truthy", 1) {
        module.exports = factory(__turbopack_context__.r("[project]/node_modules/moment/moment.js [app-client] (ecmascript)"));
    } else {
  ...
  ************************************/ function extend(a, b) {
    ...
    function getPrototypeOf(object) {
        ...
        else if (''.__proto__) return object.__proto__ // jshint ignore:line
        ;
  ...
  ************************************/ function getParseRegexForToken(token, config) {
    ...
    function dateFromArray(config) {
        ...
        if (hy == null && hm == null && hd == null) return [
            0,
            0,
            1
        ];
  ...
  ************************************/ hMoment.iDaysInMonth = function(year, month) {
        var i = getNewMoonMJDNIndex(year, month + 1), daysInMonth = ummalqura.ummalquraData[i] - ummalqura.ummalquraData[i - 1];
        return daysInMonth;
    };
  ...
  */ function h2d(hy, hm, hd) {
        var i = getNewMoonMJDNIndex(hy, hm), mjdn = hd + ummalqura.ummalquraData[i - 1] - 1, jdn = mjdn + 2400000;
        return jdn;
    }
    /*
  ...
  */ function d2h(jdn) {
        var mjdn = jdn - 2400000, i = getNewMoonMJDNIndexByJDN(mjdn), totalMonths = i + 16260, cYears = Math.floor((totalMonths - 1) / 12), hy = cYears + 1, hm = totalMonths - 12 * cYears, hd = mjdn - ummalqura.ummalquraData[i - 1] + 1;
        return {
            hy: hy,
            hm: hm,
            hd: hd
...
//# sourceMappingURL=node_modules_fc378251._.js.map